 ...
 * 无锡淘金网络科技有限公司
 */
taojin_room.controller('loginController', function ($timeout,$rootScope,$scope, $http, ServiceParticipant, $window, ServiceRoom, LxNotificationService) {

	var options;
	$rootScope.manNumber = 0;
	

//枚举	
//	var qq = {a:{name:111},b:{name:222}}
//	alert(Object.keys(qq).length)
//	for(x in qq)
//	{
//		alert(qq[x].name)
//	}

    $http.get(appConfig.httpUri+'/getAllRooms').
    ...
    $http.get(appConfig.httpUri+'/getClientConfig').
             success(function (data, status, headers, config) {
            	console.log(JSON.stringify(data));
    ...
    $http.get(appConfig.httpUri+'/getUpdateSpeakerInterval').
	    success(function (data, status, headers, config) {
    ...
    $http.get(appConfig.httpUri+'/getThresholdSpeaker').
    	success(function (data, status, headers, config) {
...
//      var wsUri = 'wss://' + location.host + '/room';
		var wsUri = appConfig.wssUri+'/room'
        ...
        var kurento = KurentoRoom(wsUri, function (error, kurento) {
            ...
            localStream.addEventListener("access-accepted", function () {
                ...
                room.addEventListener("stream-added", function (streamEvent) {
                    ...
                    var man = ServiceParticipant.getParticipants();
//                  console.log(man);
                    $timeout(function(){
                    	$rootScope.manNumber =  Object.keys(man).length;
					  },3000)
